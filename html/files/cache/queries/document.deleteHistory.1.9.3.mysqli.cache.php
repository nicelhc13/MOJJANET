...
${'history_srl27_argument'} = new ConditionArgument('history_srl', $args->history_srl, 'equal');
${'history_srl27_argument'}->checkFilter('number');
${'history_srl27_argument'}->createConditionValue();
if(!${'history_srl27_argument'}->isValid()) return ${'history_srl27_argument'}->getErrorMessage();
} else
${'history_srl27_argument'} = NULL;if(${'history_srl27_argument'} !== null) ${'history_srl27_argument'}->setColumnType('number');
...
new ConditionWithArgument('`history_srl`',$history_srl27_argument,"equal")
